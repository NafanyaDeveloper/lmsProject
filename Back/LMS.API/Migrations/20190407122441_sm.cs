           ...
           /* migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdministrationRoleId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Administration", x => new { x.DirectionId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Administration_AdministrationRoles_AdministrationRoleId",
                        column: x => x.AdministrationRoleId,
                        principalTable: "AdministrationRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Administration_Directions_DirectionId",
                        column: x => x.DirectionId,
                        principalTable: "Directions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Administration_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantRoleId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participants", x => new { x.GroupId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Administration_AdministrationRoleId",
                table: "Administration",
                column: "AdministrationRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Administration_UserId",
                table: "Administration",
                column: "UserId");
